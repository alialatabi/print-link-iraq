...
INSERT INTO public.ai_products (id, label, canvas, size_label, option_label, options, custom_size, directives, price, sort_order) VALUES
  ...
  ('sticker_circle', 'لاصق دائري', '1024x1024', null, 'قطر اللاصق', '[{"id":"d3","label":"3 سم","sizeLabel":"دائري قطر 3 سم","canvas":"1024x1024"},{"id":"d4","label":"4 سم","sizeLabel":"دائري قطر 4 سم","canvas":"1024x1024"},{"id":"d5","label":"5 سم","sizeLabel":"دائري قطر 5 سم","canvas":"1024x1024"},{"id":"d6","label":"6 سم","sizeLabel":"دائري قطر 6 سم","canvas":"1024x1024"},{"id":"d7","label":"7 سم","sizeLabel":"دائري قطر 7 سم","canvas":"1024x1024"},{"id":"d8","label":"8 سم","sizeLabel":"دائري قطر 8 سم","canvas":"1024x1024"},{"id":"d9","label":"9 سم","sizeLabel":"دائري قطر 9 سم","canvas":"1024x1024"},{"id":"d10","label":"10 سم","sizeLabel":"دائري قطر 10 سم","canvas":"1024x1024"}]'::jsonb, null, 'لاصق دائري (ستيكر) — تصميم بسيط ونص كبير واضح. اجعل خلفية/لون التصميم يمتد خارج حافة الدائرة بمقدار 0.5 سم (full bleed) ليملأ كامل الصورة المربعة حتى الحواف بلا أي هامش أبيض. لا تُظهر أي خطوط قص أو حدود bleed أو علامات قص (crop/trim marks) أو مساطر أو أرقام أو قيم قياس على التصميم. أبقِ النصوص والشعار ضمن منطقة آمنة بعيداً عن الحافة.', 1000, 10),
